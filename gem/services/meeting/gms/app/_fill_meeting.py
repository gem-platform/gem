...
def __ballot_stage(group, current_stage, proposal, action, context, state):
    ...
    return BallotMeetingStage(ballot, group=group, check_quorum=check_quorum, state=state)
